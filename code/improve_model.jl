...
function main()
    ...
    decay_rate = 0.9
    decay_freq = 500
    switch_player_type = 0        # Iteration at which we switch the opponents from random to heurisitc
    train = true
    constant_board = true
    ...
    filename = "./data/results_alpha_1e-2_epsilon_1_decay_0.9_rate_500_same_board_iter_100k_heuristic"
